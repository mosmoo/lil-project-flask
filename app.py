...
db = PostgresqlDatabase('people', user='admin',
...
Person(name='Harry', birthday=date(2001, 12, 31), age=1000).save()
Person(name='Kim Taehyung', birthday=date(1995, 12, 31), age=1000).save()
